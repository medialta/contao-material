...
?>
<script>window.tinymce || document.write('<script src="<?php echo TL_ASSETS_URL; ?>system/modules/contao-material/assets/tinymce/tinymce.gzip.js">\x3C/script>')</script>
<script>
window.tinymce && tinymce.init({
  skin: "contao-material",
